title: Plotting with Matplotlib Object Oriented Interface
---
  ...
  In this method, We first create a figure pyplot and then `object methods` are used to create plots on the axes and customize them.
---
